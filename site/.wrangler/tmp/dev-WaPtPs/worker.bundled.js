...
var Xe = /* @__PURE__ */ __name((e2, t, r) => (n, o) => {
  let s = -1;
  return a(0);
  async function a(l) {
...
var Zt = /* @__PURE__ */ __name(async (e2, t = /* @__PURE__ */ Object.create(null)) => {
  let { all: r = false, dot: n = false } = t, s = (e2 instanceof _e ? e2.raw.headers : e2.headers).get("Content-Type");
  return s?.startsWith("multipart/form-data") || s?.startsWith("application/x-www-form-urlencoded") ? In(e2, { all: r, dot: n }) : {};
}, "Zt");
async function In(e2, t) {
...
function Fn(e2, t) {
  ...
  return e2.forEach((n, o) => {
    ...
    n.includes(".") && (Bn(r, n, o), delete r[n]);
  }), r;
}
__name(Fn, "Fn");
...
var Ot = /* @__PURE__ */ __name((e2) => {
  let { groups: t, path: r } = An(e2), n = ze(r);
  return En(n, t);
}, "Ot");
var An = /* @__PURE__ */ __name((e2) => {
  let t = [];
...
var be = {};
var Mt = /* @__PURE__ */ __name((e2, t) => {
  if (e2 === "*") return "*";
  let r = e2.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
  if (r) {
    let n = `${e2}#${t}`;
    return be[n] || (r[2] ? be[n] = t && t[0] !== ":" && t[0] !== "*" ? [n, r[1], new RegExp(`^${r[2]}(?=/${t})`)] : [e2, r[1], new RegExp(`^${r[2]}$`)] : be[n] = [e2, r[1], true]), be[n];
  }
  return null;
}, "Mt");
var ye = /* @__PURE__ */ __name((e2, t) => {
  try {
    return t(e2);
  } catch {
...
var Un = /* @__PURE__ */ __name((e2) => ye(e2, decodeURI), "Un");
var Pe = /* @__PURE__ */ __name((e2) => {
  ...
  for (; n < t.length; n++) {
    ...
    if (o === 37) {
      ...
      return Un(c.includes("%25") ? c.replace(/%25/g, "%2525") : c);
...
var Ye = /* @__PURE__ */ __name((e2) => /[%+]/.test(e2) ? (e2.indexOf("+") !== -1 && (e2 = e2.replace(/\+/g, " ")), e2.indexOf("%") !== -1 ? ye(e2, He) : e2) : e2, "Ye");
var Vt = /* @__PURE__ */ __name((e2, t, r) => {
  let n;
  if (!r && t && !/[%+]/.test(t)) {
    let a = e2.indexOf("?", 8);
    if (a === -1) return;
    for (e2.startsWith(t, a + 1) || (a = e2.indexOf(`&${t}`, a + 1)); a !== -1; ) {
      ...
      if (l === 61) {
        ...
        return Ye(e2.slice(c, i === -1 ? void 0 : i));
  ...
  for (; s !== -1; ) {
    ...
    if (n && (c = Ye(c)), s = a, c === "") continue;
    let i;
    l === -1 ? i = "" : (i = e2.slice(l + 1, a === -1 ? void 0 : a), n && (i = Ye(i))), r ? (o[c] && Array.isArray(o[c]) || (o[c] = []), o[c].push(i)) : o[c] ??= i;
  }
  return t ? o[t] : o;
}, "Vt");
var jt = Vt;
var Xt = /* @__PURE__ */ __name((e2, t) => Vt(e2, t, true), "Xt");
var He = decodeURIComponent;
var Yt = /* @__PURE__ */ __name((e2) => ye(e2, He), "Yt");
var _e = class {
  static {
    __name(this, "_e");
  }
...
var zt = { Stringify: 1, BeforeStream: 2, Stream: 3 };
var Qn = /* @__PURE__ */ __name((e2, t) => {
  let r = new String(e2);
...
var Ke = class {
  ...
  get res() {
    return this.#o ||= ee(null, { headers: this.#a ??= new Headers() });
  }
  set res(e2) {
    if (this.#o && e2) {
      e2 = ee(e2.body, e2);
  ...
  header = /* @__PURE__ */ __name((e2, t, r) => {
    this.finalized && (this.#o = ee(this.#o.body, this.#o));
  ...
  #i(e2, t, r) {
    ...
    return ee(e2, { status: o, headers: n });
  }
  newResponse = /* @__PURE__ */ __name((...e2) => this.#i(...e2), "newResponse");
  body = /* @__PURE__ */ __name((e2, t, r) => this.#i(e2, t, r), "body");
  text = /* @__PURE__ */ __name((e2, t, r) => !this.#a && !this.#s && !t && !r && !this.finalized ? new Response(e2) : this.#i(e2, t, qe(Sn, r)), "text");
  ...
  html = /* @__PURE__ */ __name((e2, t, r) => {
    ...
    return typeof e2 == "object" ? Je(e2, zt.Stringify, false, {}).then(n) : n(e2);
  }, "html");
  redirect = /* @__PURE__ */ __name((e2, t) => {
    let r = String(e2);
    return this.header("Location", /[^\x00-\xFF]/.test(r) ? encodeURI(r) : r), this.newResponse(null, t ?? 302);
  }, "redirect");
  notFound = /* @__PURE__ */ __name(() => (this.#u ??= () => ee(), this.#u(this)), "notFound");
};
var b = "ALL";
var Pt = "all";
var Ht = ["get", "post", "put", "delete", "options", "patch"];
var xe = "Can not add a route since the matcher is already built.";
var Ie = class extends Error {
  static {
    __name(this, "Ie");
  }
};
var Jt = "__COMPOSED_HANDLER";
var kn = /* @__PURE__ */ __name((e2) => e2.text("404 Not Found", 404), "kn");
var qt = /* @__PURE__ */ __name((e2, t) => {
...
var Kt = class er {
  ...
  constructor(t = {}) {
    ...
    let { strict: n, ...o } = t;
    Object.assign(this, o), this.getPath = n ?? true ? t.getPath ?? Pe : Wt;
  }
  #t() {
    let t = new er({ router: this.router, getPath: this.getPath });
  ...
  route(t, r) {
    ...
    return r.routes.map((o) => {
      let s;
      r.errorHandler === qt ? s = o.handler : (s = /* @__PURE__ */ __name(async (a, l) => (await Xe([], r.errorHandler)(a, () => o.handler(a, l))).res, "s"), s[Jt] = o.handler), n.#s(o.method, o.path, s, o.basePath);
    }), this;
  }
  basePath(t) {
    let r = this.#t();
  ...
  #o(t, r, n, o) {
    ...
    let c = Xe(a[0], this.errorHandler, this.#r);
    return (async () => {
      try {
        let i = await c(l);
...
var Rn = new Set(".\\+*[^]$()");
function Gn(e2, t) {
  return e2.length === 1 ? t.length === 1 ? e2 < t ? -1 : 1 : -1 : t.length === 1 || e2 === te || e2 === re ? 1 : t === te || t === re ? -1 : e2 === Ce ? 1 : t === Ce ? -1 : e2.length === t.length ? e2 < t ? -1 : 1 : t.length - e2.length;
}
__name(Gn, "Gn");
var tr = class tt {
  static {
  ...
  insert(t, r, n, o, s) {
    ...
    let [a, ...l] = t, c = a === "*" ? l.length === 0 ? ["", "", te] : ["", "", Ce] : a === "/*" ? ["", "", re] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/), i;
    if (c) {
      let u = c[1], f = c[2] || Ce;
      if (u && c[2] && (f === ".*" || (f = f.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(f)))) throw D;
      if (i = this.#r[f], !i) {
        if (Object.keys(this.#r).some((p) => p !== te && p !== re)) throw D;
        if (s) return;
        i = this.#r[f] = new tt(), u !== "" && (i.#t = o.varIndex++);
      }
      !s && u !== "" && n.push([u, i.#t]);
    } else if (i = this.#r[a], !i) {
      if (Object.keys(this.#r).some((u) => u.length > 1 && u !== te && u !== re)) throw D;
      if (s) return;
      i = this.#r[a] = new tt();
    }
    i.insert(l, r, n, o, s);
  ...
  buildRegExpStr() {
    let r = Object.keys(this.#r).sort(Gn).map((n) => {
      let o = this.#r[n];
      return (typeof o.#t == "number" ? `(${n})@${o.#t}` : Rn.has(n) ? `\\${n}` : n) + o.buildRegExpStr();
    });
...
function or(e2) {
  return nr[e2] ??= new RegExp(e2 === "*" ? "" : `^${e2.replace(/\/\*$|([.\\+*[^\]$()])/g, (t, r) => r ? `\\${r}` : "(?:|/.*)")}$`);
}
__name(or, "or");
function Ln() {
  nr = /* @__PURE__ */ Object.create(null);
}
__name(Ln, "Ln");
function Nn(e2) {
  let t = new rr(), r = [];
...
function j(e2, t) {
  if (e2) {
    for (let r of Object.keys(e2).sort((n, o) => o.length - n.length)) if (or(r).test(t)) return [...e2[r]];
  }
}
__name(j, "j");
var Be = class {
...
var sr = class ir {
  ...
  insert(t, r, n) {
    ...
    for (let l = 0, c = s.length; l < c; l++) {
      let i = s[l], u = s[l + 1], f = Mt(i, u), p = Array.isArray(f) ? f[0] : i;
      if (p in o.#t) {
        o = o.#t[p], f && a.push(f[1]);
        continue;
      }
      o.#t[p] = new ir(), f && (o.#r.push(f), a.push(f[1])), o = o.#t[p];
    }
  ...
  #o(t, r, n, o, s) {
    for (let a = 0, l = r.#e.length; a < l; a++) {
      ...
      if (i !== void 0 && (i.params = /* @__PURE__ */ Object.create(null), t.push(i), o !== ne || s && s !== ne)) for (let f = 0, p = i.possibleKeys.length; f < p; f++) {
  ...
  search(t, r) {
    let n = [];
    this.#n = ne;
    let s = [this], a = ze(r), l = [], c = a.length, i = null;
    for (let u = 0; u < c; u++) {
      let f = a[u], p = u === c - 1, d = [];
      for (let y = 0, v = s.length; y < v; y++) {
        ...
        for (let x = 0, k = m.#r.length; x < k; x++) {
          let ve = m.#r[x], E = m.#n === ne ? {} : { ...m.#n };
          if (ve === "*") {
            let V = m.#t["*"];
            V && (this.#o(n, V, t, m.#n), V.#n = E, d.push(V));
            continue;
          }
          let [Ve, me, N] = ve;
          if (!f && !(N instanceof RegExp)) continue;
          let A = m.#t[Ve];
          if (N instanceof RegExp) {
            if (i === null) {
              i = new Array(c);
              let ge = r[0] === "/" ? 1 : 0;
              for (let K = 0; K < c; K++) i[K] = ge, ge += a[K].length + 1;
            }
            let V = r.substring(i[u]), je = N.exec(V);
            if (je) {
              if (E[me] = je[0], this.#o(n, A, t, m.#n, E), Dn(A.#t)) {
                A.#n = E;
                let ge = je[0].match(/\//)?.length ?? 0;
                (l[ge] ||= []).push(A);
              }
              continue;
            }
          }
          (N === true || N.test(f)) && (E[me] = f, p ? (this.#o(n, A, t, E, m.#n), A.#t["*"] && this.#o(n, A.#t["*"], t, E, m.#n)) : (A.#n = E, d.push(A)));
        }
      }
      let _ = l.shift();
      s = _ ? d.concat(_) : d;
...
var ot = class extends Kt {
  ...
  constructor(e2 = {}) {
    super(e2), this.router = e2.router ?? new rt({ routers: [new Be(), new nt()] });
  }
};
var Zn = /[&"<]/g;
var On = /[&<]/g;
function I(e2, t) {
  let r = String(e2 ?? ""), n = t ? Zn : On;
  n.lastIndex = 0;
  let o = "", s = 0;
  for (; n.test(r); ) {
...
function ar(e2) {
  ...
  if (typeof e2 == "string" || typeof e2 == "number") n += e2;
    ...
    var o = e2.length;
    for (t = 0; t < o; t++) e2[t] && (r = ar(e2[t])) && (n && (n += " "), n += r);
  } else for (r in e2) e2[r] && (n && (n += " "), n += r);
  return n;
}
__name(ar, "ar");
function lr() {
  for (var e2, t, r = 0, n = "", o = arguments.length; r < o; r++) (e2 = arguments[r]) && (t = ar(e2)) && (n && (n += " "), n += t);
  return n;
}
__name(lr, "lr");
var Mn = Array.prototype.indexOf;
...
__name(Ue, "Ue");
var ur = { translate: /* @__PURE__ */ new Map([[true, "yes"], [false, "no"]]) };
function B(e2, t, r = false) {
  if (e2 === "hidden" && t !== "until-found" && (r = true), t == null || !t && r) return "";
  let n = Ee.call(ur, e2) && ur[e2].get(t) || t, o = r ? '=""' : `="${I(n, true)}"`;
  return ` ${e2}${o}`;
}
__name(B, "B");
function pr(e2) {
  return typeof e2 == "object" ? lr(e2) : e2 ?? "";
}
__name(pr, "pr");
var fr = [...` 	
\r\f\xA0\v\uFEFF`];
...
function hr(e2, t) {
  if (t) {
    ...
    return n && (r += dr(n)), o && (r += dr(o, true)), r = r.trim(), r === "" ? null : r;
  }
...
var vr = "development";
var g = vr && !vr.toLowerCase().startsWith("prod");
var Y = new class extends Error {
  name = "StaleReactionError";
  message = "The reaction that called `getAbortSignal()` was re-run or destroyed";
}();
var Xi = !!globalThis.document?.contentType && globalThis.document.contentType.includes("xml");
var Z = false;
var ce = `<!--${"["}-->`;
var W = `<!--${"]"}-->`;
var Wr = ["allowfullscreen", "async", "autofocus", "autoplay", "checked", "controls", "default", "disabled", "formnovalidate", "indeterminate", "inert", "ismap", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "seamless", "selected", "webkitdirectory", "defer", "disablepictureinpicture", "disableremoteplayback"];
function Vr(e2) {
  return Wr.includes(e2);
}
__name(Vr, "Vr");
var Gd = [...Wr, "formNoValidate", "isMap", "noModule", "playsInline", "readOnly", "value", "volume", "defaultValue", "defaultChecked", "srcObject", "noValidate", "allowFullscreen", "disablePictureInPicture", "disableRemotePlayback"];
var Uo = ["$state", "$state.raw", "$derived", "$derived.by"];
var $d = [...Uo, "$state.eager", "$state.snapshot", "$props", "$props.id", "$bindable", "$effect", "$effect.pre", "$effect.tracking", "$effect.root", "$effect.pending", "$inspect", "$inspect().with", "$inspect.trace", "$host"];
var jr = null;
function Ft() {
  jr?.abort(Y), jr = null;
}
...
${t}
https://svelte.dev/e/unresolved_hydratable`, ko, Ro) : console.warn("https://svelte.dev/e/unresolved_hydratable");
}
__name(Kr, "Kr");
var en = null;
var Ze = null;
function rn() {
  let e2 = Ze ?? Oe?.getStore();
  return e2 || Hr(), e2;
}
__name(rn, "rn");
async function nn(e2) {
  if (Ze = { hydratable: { lookup: /* @__PURE__ */ new Map(), comparisons: [], unresolved_promises: /* @__PURE__ */ new Map() } }, $o()) {
    let { promise: t, resolve: r } = Ue(), n = en;
    return en = t, await n, e2().finally(r);
  }
  try {
    return Oe === null && Xr(), Oe.run(Ze, e2);
  } finally {
    Ze = null;
  }
}
...
var tn = null;
function on() {
  return tn ??= import("node:async_hooks").then((e2) => {
    Oe = new e2.AsyncLocalStorage();
  }).then(C, C), tn;
}
__name(on, "on");
function $o() {
...
async function ln(e2) {
  sn ??= new TextEncoder(), an ??= globalThis.crypto?.subtle?.digest ? globalThis.crypto : (await Lo("node:crypto")).webcrypto;
  let t = await an.subtle.digest("SHA-256", sn.encode(e2));
  return No(t);
}
__name(ln, "ln");
function No(e2) {
...
__name(fe, "fe");
var Do = Object.getOwnPropertyNames(Object.prototype).sort().join("\0");
function un(e2) {
  let t = Object.getPrototypeOf(e2);
  return t === Object.prototype || t === null || Object.getPrototypeOf(t) === null || Object.getOwnPropertyNames(t).sort().join("\0") === Do;
}
__name(un, "un");
function Me(e2) {
...
__name(fn, "fn");
var Zo = /^[a-zA-Z_$][a-zA-Z_$0-9]*$/;
function dn(e2) {
  return Zo.test(e2) ? "." + e2 : "[" + JSON.stringify(e2) + "]";
}
__name(dn, "dn");
function Oo(e2) {
    ...
    if (fe(i)) {
      ...
      switch (Me(i)) {
        ...
        case "Set":
          ...
          break;
        case "Map":
          for (let [f, p] of i) n.push(`.get(${fe(f) ? Bt(f) : "..."})`), s(p), n.pop();
          break;
        case "Int8Array":
        case "Uint8Array":
        ...
        case "Temporal.ZonedDateTime":
          return;
        default:
          if (!un(i)) throw new L("Cannot stringify arbitrary non-POJOs", n, i, e2);
          if (fn(i).length > 0) throw new L("Cannot stringify POJOs with symbolic keys", n, i, e2);
          for (let f of Object.keys(i)) {
            if (f === "__proto__") throw new L("Cannot stringify objects with __proto__ keys", n, i, e2);
            n.push(dn(f)), s(i[f]), n.pop();
          }
      }
    }
  }
  ...
  function l(i) {
    ...
    switch (u) {
      ...
      case "RegExp":
        ...
        return p ? `new RegExp(${U(f)},"${p}")` : `new RegExp(${U(f)})`;
      case "Date":
        return `new Date(${i.getTime()})`;
      case "URL":
        return `new URL(${U(i.toString())})`;
      case "URLSearchParams":
        return `new URLSearchParams(${U(i.toString())})`;
      case "Array": {
        let v = false, m = "[";
        for (let x = 0; x < i.length; x += 1) if (x > 0 && (m += ","), Object.hasOwn(i, x)) m += l(i[x]);
        else if (!v) {
          let k = pn(i), ve = k.length, E = String(i.length).length, Ve = i.length + 2, me = 25 + E + ve * (E + 2);
          if (Ve > me) {
            let N = k.map((A) => `${A}:${l(i[A])}`).join(",");
            return `Object.assign(Array(${i.length}),{${N}})`;
          }
          v = true, x -= 1;
        }
    ...
    return a.forEach((p, d) => {
      ...
      switch (_) {
        ...
        case "BigInt":
          ...
          break;
        case "RegExp":
          let { source: y, flags: v } = d, m = v ? `new RegExp(${U(y)},"${v}")` : `new RegExp(${U(y)})`;
          f.push(m);
          break;
        case "Date":
          ...
          break;
        case "URL":
          f.push(`new URL(${U(d.toString())})`);
          break;
        case "URLSearchParams":
          f.push(`new URLSearchParams(${U(d.toString())})`);
          break;
        case "Array":
...
__name(Xo, "Xo");
function hn(e2) {
  return e2.replace(Wo, Xo);
}
__name(hn, "hn");
function Yo(e2) {
  return /^[_$a-zA-Z][_$a-zA-Z0-9]*$/.test(e2) ? e2 : hn(JSON.stringify(e2));
}
__name(Yo, "Yo");
function zo(e2) {
  return /^[_$a-zA-Z][_$a-zA-Z0-9]*$/.test(e2) ? `.${e2}` : `[${hn(JSON.stringify(e2))}]`;
...
var de = class e {
  ...
  async_block(t, r) {
    this.#e.push(ce), this.async(t, r), this.#e.push(W);
  }
  async(t, r) {
    let n = r;
    if (t.length > 0) {
  ...
  child_block(t) {
    this.#e.push(ce), this.child(t), this.#e.push(W);
  }
  child(t) {
    let r = new e(this.global, this);
    this.#e.push(r);
    ...
    F({ ...w, p: n, c: null, r });
    let o = t(r);
    return F(n), o instanceof Promise && (o.catch(C), o.finally(() => F(null)).catch(C), r.global.mode === "sync" && Te(), r.promise = o), r;
  }
  boundary(t, r) {
    ...
    try {
      let s = r(n);
      F(o), s instanceof Promise && (n.global.mode === "sync" && Te(), s.catch(C), n.promise = s);
    } catch (s) {
      F(o);
      let a = t.failed;
      if (!a) throw s;
      ...
      n.#e.length = 0, n.#s = null, l instanceof Promise ? (this.global.mode === "sync" && Te(), n.promise = l.then((c) => {
        F(o), n.#e.push(e.#o(c)), a(n, c, C), n.#e.push(W);
  ...
  select(t, r, n, o, s, a, l) {
    let { value: c, ...i } = t;
    this.push(`<select${Et(i, n, o, s, a)}>`), this.child((u) => {
      u.local.select_value = c, r(u);
    }), this.push(`${l ? "<!>" : ""}</select>`);
  }
  option(t, r, n, o, s, a, l) {
    this.#e.push(`<option${Et(t, n, o, s, a)}`);
  ...
  static render(t, r = {}) {
    ...
    return Object.defineProperties(s, { html: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).body, "get") }, head: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).head, "get") }, body: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).body, "get") }, hashes: { value: { script: "" } }, then: { value: /* @__PURE__ */ __name((a, l) => {
      ...
      return o ??= on().then(() => nn(() => e.#d(t, r))), o.then((c) => (Object.defineProperty(c, "html", { get: /* @__PURE__ */ __name(() => {
        Yr();
      }, "get") }), a(c)), l);
    }, "value") } }), s;
  }
  ...
  *#u() {
  ...
  async #v() {
    let t = rn().hydratable;
    for (let [r, n] of t.unresolved_promises) Kr(n, t.lookup.get(n)?.stack ?? "<missing stack trace>");
    for (let r of t.comparisons) await r;
    return await this.#m(t);
  }
  static #p(t, r, n) {
    n.idPrefix?.includes("--") && Pr();
    var o = w;
    try {
      let s = new e(new At(t, n.idPrefix ? n.idPrefix + "-" : "", n.csp, n.transformError)), a = { p: null, c: n.context ?? null, r: s };
      return F(a), s.push(ce), r(s, n.props ?? {}), s.push(W), s;
    } finally {
      F(o);
    }
  }
...
__name(pe, "pe");
var vn = "__hono_svelte_mounted__";
var J = {};
var q = "/__svelte";
function ts(e2) {
  let t = J[e2];
...
function gn(e2, t) {
  ...
  let r = e2;
  r[vn] || (r[vn] = true, e2.get(`${q}/:filename`, async (n) => {
...
function is(e2, t, r, n) {
  let o = ts(t), s = r ? `<link rel="stylesheet" href="${q}/${o}.css">` : "", a = n.title ? `<title>${mn(n.title)}</title>` : "", l = n.head ?? "", c = n.bodyClass ? ` class="${mn(n.bodyClass)}"` : "", i = JSON.stringify(n.props ?? {}), u = ns(), f = ss(), p = u ? `<script type="importmap">${JSON.stringify({ imports: { svelte: u, "svelte/internal/client": u, "svelte/internal/disclose-version": u, ...f } })}<\/script>` : "", d = Object.values(f).map((y) => `<link rel="modulepreload" href="${y}">`).join(`
...
function Rt(e2, t) {
  return async (r) => {
    let n = t.props ?? {}, o = Ut(e2, { props: n }), s = is({ body: o.body, head: o.head }, t.hydrateAs, true, t), a = t.cacheControl ?? "public, max-age=0, must-revalidate", l = { "content-type": "text/html; charset=utf-8" };
...
function Gt(e2, t) {
  e2.component((r) => {
    ...
    r.push(`<svg class="fiber svelte-oz0aql" viewBox="0 0 1800 240" preserveAspectRatio="xMidYMid slice" aria-hidden="true"><defs><filter${B("id", `glow-${n}`)} x="-20%" y="-80%" width="140%" height="260%"><feGaussianBlur stdDeviation="2.6" result="soft"></feGaussianBlur><feMerge><feMergeNode in="soft"></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter><linearGradient${B("id", `grad-${n}`)} x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#f6821f" stop-opacity="0"></stop><stop offset="38%" stop-color="#f6821f" stop-opacity="0.9"></stop><stop offset="64%" stop-color="#8ea6c4" stop-opacity="0.7"></stop><stop offset="100%" stop-color="#8ea6c4" stop-opacity="0"></stop></linearGradient></defs><path fill="none"${B("stroke", `url(#grad-${n})`)} stroke-width="3" stroke-linecap="round"${B("filter", `url(#glow-${n})`)} opacity="0.15"${B("d", o[0])}><animate attributeName="d"${B("dur", a)} repeatCount="indefinite"${B("values", s)} calcMode="spline" keyTimes="0;0.2;0.4;0.6;0.8;1" keySplines="0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1"></animate></path><path fill="none"${B("stroke", `url(#grad-${n})`)} stroke-width="0.8" stroke-linecap="round" opacity="0.5"${B("d", o[0])}><animate attributeName="d"${B("dur", a)} repeatCount="indefinite"${B("values", s)} calcMode="spline" keyTimes="0;0.2;0.4;0.6;0.8;1" keySplines="0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1;0.45 0 0.55 1"></animate></path></svg>`);
  });
}
__name(Gt, "Gt");
function $t(e2) {
  ...
  e2.push('<div class="page svelte-1n46o8q"><section class="hero svelte-1n46o8q"><div class="wash svelte-1n46o8q" aria-hidden="true"></div> '), Gt(e2, {}), e2.push(`<!----> <div class="wrap hero-wrap svelte-1n46o8q"><header class="head svelte-1n46o8q"><div class="brand svelte-1n46o8q"><span class="mark svelte-1n46o8q" aria-hidden="true"></span> <span class="wordmark svelte-1n46o8q">loops<span class="ext svelte-1n46o8q">.yaml</span></span></div> <nav class="nav svelte-1n46o8q"><a class="navlink svelte-1n46o8q" href="/recipes">Recipes</a> <a class="ghlink svelte-1n46o8q" href="https://github.com/acoyfellow/loops-yaml">GitHub \u2197</a></nav></header> <div class="hero-copy svelte-1n46o8q"><h1 class="svelte-1n46o8q">A loop is a schedule<br class="svelte-1n46o8q"/>plus a command.</h1> <p class="lede svelte-1n46o8q">Run commands on a cron schedule, or on demand. Nothing else to learn.</p> <div class="cta svelte-1n46o8q"><code class="svelte-1n46o8q">bun add -g github:acoyfellow/loops-yaml</code></div></div></div></section> <section class="canvas svelte-1n46o8q" style="background-image:url('/art/field-cream-blue-v2.jpg')"><div class="wrap canvas-inner svelte-1n46o8q"><div class="on-cream svelte-1n46o8q"><p class="kicker dark svelte-1n46o8q">define</p> <pre class="code svelte-1n46o8q">loops:
  review:
    schedule: "0 8 * * *"   # 8am daily; omit for on-demand
...
__name($t, "$t");
var bn = [{ id: "backup", label: "Backup" }, { id: "watch", label: "Watch" }, { id: "cloudflare", label: "Cloudflare" }, { id: "health", label: "Health" }, { id: "notify", label: "Notify" }, { id: "chores", label: "Chores" }, { id: "data", label: "Data" }];
var Lt = [{ id: "sqlite-backup-r2", title: "Nightly SQLite \u2192 R2", blurb: "Snapshot a SQLite DB and push it to an R2 bucket. Offsite backup in two lines.", category: "backup", needs: ["sqlite3", "wrangler"], schedule: "0 3 * * *", run: `sqlite3 app.db ".backup /tmp/app-$(date +%F).db" && \\
  wrangler r2 object put backups/app-$(date +%F).db --file /tmp/app-$(date +%F).db` }, { id: "dir-to-r2", title: "Mirror a folder to R2", blurb: "Rsync-style upload of a working directory to R2 so a wiped VPS costs you nothing.", category: "backup", needs: ["tar", "wrangler"], schedule: "0 */6 * * *", run: `tar czf /tmp/site.tgz ./site && \\
  wrangler r2 object put backups/site-$(date +%FT%H).tgz --file /tmp/site.tgz` }, { id: "pg-dump-r2", title: "Postgres dump to R2", blurb: "Compressed pg_dump straight into object storage. Keep the last 7 by date in the key.", category: "backup", needs: ["pg_dump", "gzip", "wrangler"], schedule: "30 2 * * *", run: `pg_dump "$DATABASE_URL" | gzip | \\
  wrangler r2 object put db/pg-$(date +%F).sql.gz --pipe` }, { id: "cert-expiry", title: "TLS cert expiry check", blurb: "Alert before a certificate expires. Catches the outage everyone forgets about.", category: "health", needs: ["openssl", "curl"], schedule: "0 9 * * *", run: `END=$(echo | openssl s_client -servername $DOMAIN -connect $DOMAIN:443 2>/dev/null \\
  | openssl x509 -noout -enddate | cut -d= -f2); \\
...
function Nt(e2, t) {
  e2.component((r) => {
    ...
    n = Lt.map((u) => ({ r: u, s: yn(o, a(u)) })).filter(({ r: u, s: f }) => (s === "all" || u.category === s) && f !== -1).sort((u, f) => f.s - u.s).map(({ r: u }) => u), r.push(`<div class="page svelte-1485eum"><div class="wrap svelte-1485eum"><header class="head svelte-1485eum"><a class="brand svelte-1485eum" href="/"><span class="mark svelte-1485eum" aria-hidden="true"></span> <span class="wordmark svelte-1485eum">loops<span class="ext svelte-1485eum">.yaml</span></span></a> <a class="ghlink svelte-1485eum" href="https://github.com/acoyfellow/loops-yaml">GitHub \u2197</a></header> <section class="intro svelte-1485eum"><p class="kicker svelte-1485eum">Recipes</p> <h1 class="svelte-1485eum">Small loops, real leverage.</h1> <p class="lede svelte-1485eum">A loop is a schedule plus a command \u2014 so the question is just <em class="svelte-1485eum">what command?</em> A VPS, a coding agent, and a Cloudflare token go a long way. These are the kind of
        useful, unglamorous jobs you can wire up in a minute. Copy one into <code class="svelte-1485eum">loops.yaml</code> and change the values.</p></section> <div class="controls svelte-1485eum"><label class="search-wrap svelte-1485eum"><span class="search-prompt svelte-1485eum">/</span> <input class="search svelte-1485eum" type="search" placeholder="filter \u2014 r2, cert, dns, backup\u2026"${B("value", o)} aria-label="Filter recipes"/></label> <div class="filters svelte-1485eum" role="tablist" aria-label="Filter by category"><button${Qt("filter svelte-1485eum", void 0, { on: s === "all" })}>all</button> <!--[-->`);
    let c = pe(bn);
    for (let u = 0, f = c.length; u < f; u++) {
      let p = c[u];
      r.push(`<button${Qt("filter svelte-1485eum", void 0, { on: s === p.id })}>${I(p.label.toLowerCase())}</button>`);
    }
    r.push(`<!--]--></div></div> <p class="count svelte-1485eum">${I(n.length)} / ${I(Lt.length)} shown</p> `), n.length === 0 ? (r.push("<!--[0-->"), r.push('<p class="empty svelte-1485eum">Nothing matches. Try fewer letters.</p>')) : r.push("<!--[-1-->"), r.push('<!--]--> <ol class="index svelte-1485eum"><!--[-->');
    let i = pe(n);
...
// .wrangler/tmp/bundle-nT5uNM/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = Mh;
...
// .wrangler/tmp/bundle-nT5uNM/middleware-loader.entry.ts
