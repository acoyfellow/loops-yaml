...
var Ot = /* @__PURE__ */ __name(async (e2, t = /* @__PURE__ */ Object.create(null)) => {
...
var He = /* @__PURE__ */ __name((e2) => {
  let t = e2.split("/");
  return t[0] === "" && t.shift(), t;
}, "He");
var Mt = /* @__PURE__ */ __name((e2) => {
  let { groups: t, path: r } = Un(e2), n = He(r);
  return En(n, t);
}, "Mt");
...
var Pe = /* @__PURE__ */ __name((e2) => /[%+]/.test(e2) ? (e2.indexOf("+") !== -1 && (e2 = e2.replace(/\+/g, " ")), e2.indexOf("%") !== -1 ? we(e2, qe) : e2) : e2, "Pe");
var Xt = /* @__PURE__ */ __name((e2, t, r) => {
  let n;
  if (!r && t && !/[%+]/.test(t)) {
    let a = e2.indexOf("?", 8);
    if (a === -1) return;
    for (e2.startsWith(t, a + 1) || (a = e2.indexOf(`&${t}`, a + 1)); a !== -1; ) {
      ...
      if (l === 61) {
        ...
        return Pe(e2.slice(c, i === -1 ? void 0 : i));
  ...
  for (; s !== -1; ) {
    ...
    if (n && (c = Pe(c)), s = a, c === "") continue;
    let i;
    l === -1 ? i = "" : (i = e2.slice(l + 1, a === -1 ? void 0 : a), n && (i = Pe(i))), r ? (o[c] && Array.isArray(o[c]) || (o[c] = []), o[c].push(i)) : o[c] ??= i;
  }
  return t ? o[t] : o;
}, "Xt");
var jt = Xt;
var Yt = /* @__PURE__ */ __name((e2, t) => Xt(e2, t, true), "Yt");
var qe = decodeURIComponent;
var zt = /* @__PURE__ */ __name((e2) => we(e2, qe), "zt");
var _e = class {
  static {
    __name(this, "_e");
  }
...
var _ = "ALL";
var Ht = "all";
var Jt = ["get", "post", "put", "delete", "options", "patch"];
...
var er = class tr {
  ...
  constructor(t = {}) {
    ...
    let { strict: n, ...o } = t;
    Object.assign(this, o), this.getPath = n ?? true ? t.getPath ?? Je : Vt;
  }
  #t() {
    let t = new tr({ router: this.router, getPath: this.getPath });
  ...
  route(t, r) {
    ...
    return r.routes.map((o) => {
      let s;
      r.errorHandler === Kt ? s = o.handler : (s = /* @__PURE__ */ __name(async (a, l) => (await ze([], r.errorHandler)(a, () => o.handler(a, l))).res, "s"), s[qt] = o.handler), n.#s(o.method, o.path, s, o.basePath);
    }), this;
  }
  basePath(t) {
    let r = this.#t();
...
function sr(e2) {
  return or[e2] ??= new RegExp(e2 === "*" ? "" : `^${e2.replace(/\/\*$|([.\\+*[^\]$()])/g, (t, r) => r ? `\\${r}` : "(?:|/.*)")}$`);
}
__name(sr, "sr");
function $n() {
...
function Dn(e2) {
  ...
  for (let i = 0, u = -1, f = n.length; i < f; i++) {
    let [p, d, b] = n[i];
    p ? o[d] = [b.map(([v]) => [v, /* @__PURE__ */ Object.create(null)]), Be] : u++;
    let y;
    try {
      y = t.insert(d, u, p);
    } catch (v) {
  ...
  for (let i = 0, u = r.length; i < u; i++) for (let f = 0, p = r[i].length; f < p; f++) {
    ...
    if (!d) continue;
    let b = Object.keys(d);
    for (let y = 0, v = b.length; y < v; y++) d[b[y]] = l[d[b[y]]];
  }
  let c = [];
...
function X(e2, t) {
  if (e2) {
    for (let r of Object.keys(e2).sort((n, o) => o.length - n.length)) if (sr(r).test(t)) return [...e2[r]];
  }
}
__name(X, "X");
var Ae = class {
...
var ir = class ar {
  ...
  insert(t, r, n) {
    ...
    for (let l = 0, c = s.length; l < c; l++) {
      let i = s[l], u = s[l + 1], f = Wt(i, u), p = Array.isArray(f) ? f[0] : i;
      if (p in o.#t) {
        o = o.#t[p], f && a.push(f[1]);
        continue;
      }
      o.#t[p] = new ar(), f && (o.#r.push(f), a.push(f[1])), o = o.#t[p];
    }
  ...
  #o(t, r, n, o, s) {
    for (let a = 0, l = r.#e.length; a < l; a++) {
      ...
      if (i !== void 0 && (i.params = /* @__PURE__ */ Object.create(null), t.push(i), o !== oe || s && s !== oe)) for (let f = 0, p = i.possibleKeys.length; f < p; f++) {
        let d = i.possibleKeys[f], b = u[i.score];
        i.params[d] = s?.[d] && !b ? s[d] : o[d] ?? s?.[d], u[i.score] = true;
      }
    }
  }
  search(t, r) {
    let n = [];
    this.#n = oe;
    let s = [this], a = He(r), l = [], c = a.length, i = null;
    for (let u = 0; u < c; u++) {
      let f = a[u], p = u === c - 1, d = [];
...
function lr(e2) {
  ...
  if (typeof e2 == "string" || typeof e2 == "number") n += e2;
    ...
    var o = e2.length;
    for (t = 0; t < o; t++) e2[t] && (r = lr(e2[t])) && (n && (n += " "), n += r);
  } else for (r in e2) e2[r] && (n && (n += " "), n += r);
  return n;
}
__name(lr, "lr");
function cr() {
  for (var e2, t, r = 0, n = "", o = arguments.length; r < o; r++) (e2 = arguments[r]) && (t = lr(e2)) && (n && (n += " "), n += t);
  return n;
}
__name(cr, "cr");
...
__name(Qe, "Qe");
var fr = { translate: /* @__PURE__ */ new Map([[true, "yes"], [false, "no"]]) };
function C(e2, t, r = false) {
  if (e2 === "hidden" && t !== "until-found" && (r = true), t == null || !t && r) return "";
  let n = Ee.call(fr, e2) && fr[e2].get(t) || t, o = r ? '=""' : `="${I(n, true)}"`;
  return ` ${e2}${o}`;
}
__name(C, "C");
function hr(e2) {
  return typeof e2 == "object" ? cr(e2) : e2 ?? "";
}
__name(hr, "hr");
var dr = [...` 	
\r\f\xA0\v\uFEFF`];
function ct(e2, t, r) {
  ...
  if (t && (n = n ? n + " " + t : t), r) {
    for (var o of Object.keys(r)) if (r[o]) n = n ? n + " " + o : o;
      ...
      var l = a + s;
      (a === 0 || dr.includes(n[a - 1])) && (l === n.length || dr.includes(n[l])) ? n = (a === 0 ? "" : n.substring(0, a)) + n.substring(l + 1) : a = l;
    }
  }
  return n === "" ? null : n;
}
__name(ct, "ct");
function pr(e2, t = false) {
  var r = t ? " !important;" : ";", n = "";
...
function vr(e2, t) {
  if (t) {
    ...
    return n && (r += pr(n)), o && (r += pr(o, true)), r = r.trim(), r === "" ? null : r;
  }
...
var mr = "development";
var g = mr && !mr.toLowerCase().startsWith("prod");
...
var ue = `<!--${"["}-->`;
var W = `<!--${"]"}-->`;
var Vr = ["allowfullscreen", "async", "autofocus", "autoplay", "checked", "controls", "default", "disabled", "formnovalidate", "indeterminate", "inert", "ismap", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "seamless", "selected", "webkitdirectory", "defer", "disablepictureinpicture", "disableremoteplayback"];
function Xr(e2) {
  return Vr.includes(e2);
}
__name(Xr, "Xr");
var Ld = [...Vr, "formNoValidate", "isMap", "noModule", "playsInline", "readOnly", "value", "volume", "defaultValue", "defaultChecked", "srcObject", "noValidate", "allowFullscreen", "disablePictureInPicture", "disableRemotePlayback"];
...
async function on(e2) {
  if (Oe = { hydratable: { lookup: /* @__PURE__ */ new Map(), comparisons: [], unresolved_promises: /* @__PURE__ */ new Map() } }, No()) {
    let { promise: t, resolve: r } = Qe(), n = tn;
    return tn = t, await n, e2().finally(r);
  }
  try {
    return Me === null && Yr(), Me.run(Oe, e2);
  } finally {
    Oe = null;
  }
}
...
var rn = null;
function sn() {
  return rn ??= import("node:async_hooks").then((e2) => {
...
async function cn(e2) {
  an ??= new TextEncoder(), ln ??= globalThis.crypto?.subtle?.digest ? globalThis.crypto : (await $o("node:crypto")).webcrypto;
  let t = await ln.subtle.digest("SHA-256", an.encode(e2));
  return Do(t);
}
__name(cn, "cn");
function Do(e2) {
    ...
    if (de(i)) {
      ...
      switch (We(i)) {
        ...
        case "Temporal.ZonedDateTime":
          return;
        default:
          if (!fn(i)) throw new N("Cannot stringify arbitrary non-POJOs", n, i, e2);
          if (dn(i).length > 0) throw new N("Cannot stringify POJOs with symbolic keys", n, i, e2);
          for (let f of Object.keys(i)) {
            if (f === "__proto__") throw new N("Cannot stringify objects with __proto__ keys", n, i, e2);
            n.push(pn(f)), s(i[f]), n.pop();
          }
      }
    }
  }
    ...
    switch (u) {
      ...
      case "Array": {
        ...
        for (let x = 0; x < i.length; x += 1) if (x > 0 && (m += ","), Object.hasOwn(i, x)) m += l(i[x]);
          ...
          let k = hn(i), me = k.length, U = String(i.length).length, je = i.length + 2, ge = 25 + U + me * (U + 2);
          if (je > ge) {
      ...
      default:
        let d = Object.keys(i), b = d.map((v) => `${zo(v)}:${l(i[v])}`).join(",");
        return Object.getPrototypeOf(i) === null ? d.length > 0 ? `{${b},__proto__:null}` : "{__proto__:null}" : `{${b}}`;
    }
  }
  __name(l, "l");
  let c = l(e2);
...
__name(vn, "vn");
function zo(e2) {
  return /^[_$a-zA-Z][_$a-zA-Z0-9]*$/.test(e2) ? e2 : vn(JSON.stringify(e2));
}
__name(zo, "zo");
function Po(e2) {
  return /^[_$a-zA-Z][_$a-zA-Z0-9]*$/.test(e2) ? `.${e2}` : `[${vn(JSON.stringify(e2))}]`;
...
var pe = class e {
  ...
  static render(t, r = {}) {
    ...
    return Object.defineProperties(s, { html: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).body, "get") }, head: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).head, "get") }, body: { get: /* @__PURE__ */ __name(() => (n ??= e.#a(t, r)).body, "get") }, hashes: { value: { script: "" } }, then: { value: /* @__PURE__ */ __name((a, l) => {
      ...
      return o ??= sn().then(() => on(() => e.#d(t, r))), o.then((c) => (Object.defineProperty(c, "html", { get: /* @__PURE__ */ __name(() => {
        zr();
      }, "get") }), a(c)), l);
    }, "value") } }), s;
  }
  ...
  *#u() {
  ...
  async #v() {
    let t = nn().hydratable;
    for (let [r, n] of t.unresolved_promises) en(n, t.lookup.get(n)?.stack ?? "<missing stack trace>");
    for (let r of t.comparisons) await r;
    return await this.#m(t);
  }
  static #p(t, r, n) {
    n.idPrefix?.includes("--") && Hr();
    var o = w;
    try {
...
function Qt(e2, t, r, n, o = 0) {
  n && (e2.style = vr(e2.style, n)), e2.class && (e2.class = hr(e2.class)), (t || r) && (e2.class = ct(e2.class, t, r));
  ...
  for (a of Object.keys(e2)) if (typeof e2[a] != "function" && !(a[0] === "$" && a[1] === "$") && !(a === "" || ts.test(a))) {
    ...
    c && (a = f), !(f.length > 2 && f.startsWith("on")) && (i && (a === "defaultvalue" || a === "defaultchecked") && (a = a === "defaultvalue" ? "value" : "checked", e2[a]) || (s += C(a, u, l && Xr(a))));
  }
  return s;
}
__name(Qt, "Qt");
...
__name(he, "he");
var mn = "__hono_svelte_mounted__";
var J = {};
var q = "/__svelte";
function rs(e2) {
  let t = J[e2];
...
function bn(e2, t) {
  ...
  let r = e2;
  r[mn] || (r[mn] = true, e2.get(`${q}/:filename`, async (n) => {
    ...
    let b = i === "js" ? new Response(u.js, { headers: { "content-type": "application/javascript; charset=utf-8", "cache-control": p } }) : new Response(u.css, { headers: { "content-type": "text/css; charset=utf-8", "cache-control": p } });
    return d && n.executionCtx.waitUntil(d.put(n.req.raw, b.clone())), b;
  }));
}
__name(bn, "bn");
function gn(e2) {
...
function as(e2, t, r, n) {
  let o = rs(t), s = r ? `<link rel="stylesheet" href="${q}/${o}.css">` : "", a = n.title ? `<title>${gn(n.title)}</title>` : "", l = n.head ?? "", c = n.bodyClass ? ` class="${gn(n.bodyClass)}"` : "", i = JSON.stringify(n.props ?? {}), u = os(), f = is(), p = u ? `<script type="importmap">${JSON.stringify({ imports: { svelte: u, "svelte/internal/client": u, "svelte/internal/disclose-version": u, ...f } })}<\/script>` : "", d = Object.values(f).map((y) => `<link rel="modulepreload" href="${y}">`).join(`
`), b = u ? `<link rel="modulepreload" href="${u}">
${d}` : d;
  return `<!doctype html>
<html lang="en">
<head>
...
__name(Lt, "Lt");
var yn = [{ id: "backup", label: "Backup" }, { id: "watch", label: "Watch" }, { id: "cloudflare", label: "Cloudflare" }, { id: "health", label: "Health" }, { id: "notify", label: "Notify" }, { id: "chores", label: "Chores" }, { id: "data", label: "Data" }];
...
function $t(e2, t) {
  e2.component((r) => {
    ...
    n = Nt.map((u) => ({ r: u, s: wn(o, a(u)) })).filter(({ r: u, s: f }) => (s === "all" || u.category === s) && f !== -1).sort((u, f) => f.s - u.s).map(({ r: u }) => u), r.push(`<div class="page svelte-1485eum"><div class="wrap svelte-1485eum"><header class="head svelte-1485eum"><a class="brand svelte-1485eum" href="/"><span class="mark svelte-1485eum" aria-hidden="true"></span> <span class="wordmark svelte-1485eum">loops<span class="ext svelte-1485eum">.yaml</span></span></a> <a class="ghlink svelte-1485eum" href="https://github.com/acoyfellow/loops-yaml">GitHub \u2197</a></header> <section class="intro svelte-1485eum"><p class="kicker svelte-1485eum">Recipes</p> <h1 class="svelte-1485eum">Small loops, real leverage.</h1> <p class="lede svelte-1485eum">A loop is a schedule plus a command \u2014 so the question is just <em class="svelte-1485eum">what command?</em> A VPS, a coding agent, and a Cloudflare token go a long way. These are the kind of
...
var K = new it();
bn(K, { bundles: _n });
K.get("/", Xe(Lt, { hydrateAs: "app", title: "loops.yaml \u2014 schedule a command, or run it on demand", head: Zt({ path: "/", title: "loops.yaml \u2014 schedule a command, or run it on demand", description: "Run commands on a cron schedule, or on demand. A loop is a schedule plus a command \u2014 nothing else." }), props: {} }));
K.get("/recipes", Xe($t, { hydrateAs: "recipes", title: "loops.yaml \u2014 recipes: small loops, real leverage", head: Zt({ path: "/recipes", title: "loops.yaml recipes \u2014 small loops, real leverage", description: "A grounded collection of small, useful loops: backups, health checks, Cloudflare automation, watchers. VPS + agent + Cloudflare = freedom through simplicity." }), props: {} }));
K.get("/share", Xe(Dt, { hydrateAs: "share", title: "loops.yaml", props: {} }));
...
// .wrangler/tmp/bundle-3UQnD0/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = Hh;
...
// .wrangler/tmp/bundle-3UQnD0/middleware-loader.entry.ts
